...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="https://fonts.googleapis.com/css?family=Roboto:400,500,600,700&display=swap">
  <link rel="stylesheet" type="text/css" href="<?php echo $actual_link ?>/public/css/footer_mobie.css">
  <link rel="stylesheet" type="text/css" href="<?php echo $actual_link ?>/public/css/home.css">
  <link rel="stylesheet" type="text/css" href="<?php echo $actual_link ?>/public/css/loading.css">
  <link rel="shortcut icon" type="text/css" href="<?php echo $actual_link ?>/public/images/default/icon.ico" type="image/x-icon">
        ...
        <span class="search-icon">
          <?php if (isset($_SESSION['name'])) { ?>
            ...
            <ul class="items-user">
              ...
              <li class="items-user-link"><a href="<?php echo $actual_link ?>/home/account_info">Tài khoản</a></li>
              <hr>
